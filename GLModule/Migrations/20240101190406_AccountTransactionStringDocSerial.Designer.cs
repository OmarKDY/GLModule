...
namespace GLModule.Migrations
{
    ...
    [Migration("20240101190406_AccountTransactionStringDocSerial")]
    partial class AccountTransactionStringDocSerial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GLModule.Domain.Entities.AccountTransaction", b =>
                {
                    ...
                    b.Property<bool>("IsDailyJournal")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("DocSerial")
                        .IsUnique()
                        .HasFilter("[DocSerial] IS NOT NULL");
